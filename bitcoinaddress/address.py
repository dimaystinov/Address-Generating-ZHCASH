...
class Address:
    ...
    def __str__(self, testnet=False):
        ...
        return """\r"Public_Key": "%s",
                      \r"Public_Key_compressed": "%s",
                      \r"Public_Address_1": "%s", 
                      \r"Public_Address_1_compressed": "%s",   
                      \r"Public_Address_3": "%s",
                      \r"Public_Address_bc1_P2WPKH": "%s",    
                      \r"Public_Address_bc1_P2WSH": "%s"} 
                    """ % (params)
